    ...
    <section id="contact" className="bg-background py-24">
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-muted-foreground leading-relaxed">
          Get in touch today for a free, no-obligation quote. We cover Steyning,
          Worthing, Brighton, and all surrounding areas in West Sussex.
        </p>
        ...
        <div className="mt-8 flex items-center justify-center gap-6">
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 text-sm font-medium transition-opacity hover:opacity-80"
          ...
          >
            ...
            <span className="text-foreground/80">Facebook</span>
          </Link>
          <Link
